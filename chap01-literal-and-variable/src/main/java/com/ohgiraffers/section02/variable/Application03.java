...
public class Application03 {
    public static void main(String[] args){
        ...
        *       int inum;
        *       int inum;
        *   1-2. 예약어(int, short, byte 등등의 약속된 규칙어)는 사용이 불가능하다.
        *       int int;
        *       short short;
        ...
        *   2-1. 변수명의 길이는 제한이 없다.
        *       int sljfaejsljfasoejaljdlkjafsoiajslfjlaj;
        *   2-2. 변수명의 합성어로 이루어진 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작된다.(camel-case)
        *       int maxNum;
        *   2-3. 단어와 단어 사이의 연결을 언더스코어로 하지 않는다.
        *
        ...
        * */
        ...
        System.out.println("저의 이름은 "+name+"이고, 나이는 "+age+"살 "+gender+"입니다.");
