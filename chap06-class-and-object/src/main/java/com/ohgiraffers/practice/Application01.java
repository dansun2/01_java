...
//        go.num = 3;
        ...
        while (!yes.equalsIgnoreCase("도서 반납")) {
            if (yes.equalsIgnoreCase("도서 대여")) {
                ...
                if (response.equals("네")) {
                    ...
                    System.out.print("대여를 계속하시겠습니까? ( 네 / 아니오 ) : ");

                    String no = sc2.nextLine();
