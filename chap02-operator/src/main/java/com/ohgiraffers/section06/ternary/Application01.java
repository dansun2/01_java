...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 항목이 3개 : (조건식)? 참일 경우 : 거짓일 경우
        * 조건식은 반드시 결과가 treu || false가 나오도록 해야한다.
         */
        int num = 10;
        int num2 = -10;
        // num과 num2를 삼항 연산자를 이용하여 양수 또는 음수로 표현해주세요.
        String result1 = (num>0)? "양수이다." : "음수이다.";
        ...
        System.out.println( ((num3>0)? "양수이다." : (num3 == 0)? "0이다" : "음수이다"));
